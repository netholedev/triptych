...
type UsersService interface {
	Register(context.Context, *models.UserRegisterDto) (*models.User, *exceptions.ErrorResponse)
	Login(context.Context, *models.UserLoginDto) (*models.User, *exceptions.ErrorResponse)
	Profile(context.Context, string) (*models.User, *exceptions.ErrorResponse)
	ConfirmRegistration(context.Context, string) (bool, *exceptions.ErrorResponse)
	PasswordResetRequest(context.Context, *models.UserPasswordResetRequestDto) (bool, *exceptions.ErrorResponse)
	SetNewPassword(context.Context, string, *models.UserSetNewPasswordDto) (bool, *exceptions.ErrorResponse)

	ValidateWithToken(context.Context, string) (*models.User, *exceptions.ErrorResponse)
	RefreshToken(context.Context, string, string) (*models.User, *exceptions.ErrorResponse)
...
func (us *usersService) Register(ctx context.Context, dto *models.UserRegisterDto) (*models.User, *exceptions.ErrorResponse) {
...
func (us *usersService) Login(ctx context.Context, dto *models.UserLoginDto) (*models.User, *exceptions.ErrorResponse) {
...
func (us *usersService) PasswordResetRequest(ctx context.Context, dto *models.UserPasswordResetRequestDto) (bool, *exceptions.ErrorResponse) {
	foundUsers, err := us.ur.FindByEmail(ctx, dto.Email)
	if err != nil {
...
func (us *usersService) SetNewPassword(ctx context.Context, token string, dto *models.UserSetNewPasswordDto) (bool, *exceptions.ErrorResponse) {
...
func (us *usersService) RefreshToken(ctx context.Context, token, refreshToken string) (*models.User, *exceptions.ErrorResponse) {
...
func (us *usersService) ValidateWithToken(ctx context.Context, token string) (*models.User, *exceptions.ErrorResponse) {
...
func (us *usersService) Profile(ctx context.Context, id string) (*models.User, *exceptions.ErrorResponse) {
