...
func NewUsersRepository(ctx context.Context, db driver.Database) (UsersRepository, error) {
	col, err := storage.CollectionArangoDb(collectionName, ctx, db)
	if err != nil {
		return nil, err
	}
...
func (ur *usersRepository) Create(ctx context.Context, user *models.User) (driver.DocumentID, error) {
...
func (ur *usersRepository) FindByEmail(ctx context.Context, email string) ([]models.User, error) {
...
func (ur *usersRepository) FindByAccessToken(ctx context.Context, token string, forceExpired bool) ([]models.User, error) {
	foundUsers := []models.User{}
...
func (ur *usersRepository) FindByConfirmationToken(ctx context.Context, token string) ([]models.User, error) {
	foundUsers := []models.User{}
...
func (ur *usersRepository) FindByTokens(ctx context.Context, token string, refreshToken string, forceExpired bool) ([]models.User, error) {
	foundUsers := []models.User{}
...
func (ur *usersRepository) SetNewTokens(ctx context.Context, user *models.User) error {
...
func (ur *usersRepository) SetNewPasswordResetRequest(ctx context.Context, user *models.User) error {
	patch := map[string]interface{}{
...
func (ur *usersRepository) SetNewPassword(ctx context.Context, user *models.User) ([]models.User, error) {
	foundUsers := []models.User{}
...
func (ur *usersRepository) FindById(ctx context.Context, id string) (models.User, error) {
	user := models.User{}
