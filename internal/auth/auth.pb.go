...
var file_internal_auth_auth_proto_rawDesc = []byte{
	...
	0x1a, 0x23, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x72, 0x6f, 0x72, 0x73, 0x32, 0xb4, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	0x22, 0x00, 0x12, 0x37, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x13, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
...
var file_internal_auth_auth_proto_goTypes = []interface{}{
	...
	(*common.Empty)(nil),        // 6: common.empty.Empty
}
var file_internal_auth_auth_proto_depIdxs = []int32{
	...
	6, // 3: auth.AuthService.Profile:input_type -> common.empty.Empty
...
type AuthServiceClient interface {
	...
	Profile(ctx context.Context, in *common.Empty, opts ...grpc.CallOption) (*ProfileResponse, error)
}
...
func (c *authServiceClient) Profile(ctx context.Context, in *common.Empty, opts ...grpc.CallOption) (*ProfileResponse, error) {
...
type AuthServiceServer interface {
	...
	Profile(context.Context, *common.Empty) (*ProfileResponse, error)
}
...
func (*UnimplementedAuthServiceServer) Profile(context.Context, *common.Empty) (*ProfileResponse, error) {
...
func _AuthService_Profile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Profile(ctx, req.(*common.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
