...
{#if show}
	<div
		...
		class="fixed flex flex-col w-64 bg-white h-full border-r"
	>
		<div class="overflow-y-auto overflow-x-hidden flex-grow lg:pt-12 pt-14">
			<ul class="flex flex-col py-4 space-y-1">
				...
				<li>
					<a
						href="#"
						class="relative flex flex-row items-center py-3 focus:outline-none hover:bg-gray-50 text-gray-500 font-medium hover:text-gray-800 border-l-4 border-transparent hover:border-red-500 pr-6"
					>
